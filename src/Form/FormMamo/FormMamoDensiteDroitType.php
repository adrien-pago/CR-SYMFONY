...
class FormMamoDensiteDroitType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('asymetrie_globale_valeur_droite', TextType::class, [
            'required' => false,
        ...
        ->add('asymetrie_simple_valeur_autre_droite', TextType::class, [
            'required' => false,
            'attr' => [
                'class' => 'form-control',
        ...
        ->add('distorsion_architecturale_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Non' => 'non',
        ...
        ->add('distorsion_intramammaire_topographie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('distorsion_intramammaire_quadrant_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('distorsion_intramammaire_union_quadrants_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('distorsion_intramammaire_densite_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('distorsion_bords_topographie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'superficiel' => 'superficiel',
                'profond' => 'profond'
        ...
        ->add('distorsion_bords_localisation_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('distorsion_bords_quadrant_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supéroexterne' => 'superoexterne',
                'supérointerne' => 'superointerne',
        ...
        ->add('distorsion_bords_union_quadrants_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supérieurs' => 'superieurs',
                'internes' => 'internes',
        ...
        ->add('distorsion_bords_type_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        // Masse
        ->add('masse_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Non' => 'non',
                'Oui' => 'oui'
        ...
        ->add('masse_topographie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'du quadrant' => 'quadrant',
                'à l\'union' => 'union',
        ...
        ->add('masse_quadrant_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supéroexterne' => 'superoexterne',
                'supérointerne' => 'superointerne',
        ...
        ->add('masse_union_quadrants_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supérieurs' => 'superieurs',
                'internes' => 'internes',
        ...
        ->add('masse_profondeur_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'antérieur' => 'anterieur',
                'moyen' => 'moyen',
        ...
        ->add('masse_taille_x_droite', TextType::class, [
            'required' => false,
            'attr' => [
                'class' => 'form-control',
                'type' => 'number',
        ...
        ->add('masse_taille_y_droite', TextType::class, [
            'required' => false,
            'attr' => [
                'class' => 'form-control',
                'type' => 'number',
        ...
        ->add('masse_forme_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'ovale' => 'ovale',
                'ronde' => 'ronde',
        ...
        ->add('masse_contours_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('masse_densite_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('masse_calcifications_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Présence' => 'presence',
                'Absence' => 'absence'
        ...
        ->add('masse_anteriorite_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('microcalcifications_suspectes_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Non' => 'non',
                'Oui' => 'oui'
        ...
        ->add('microcalcifications_distribution_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Diffuse' => 'diffuse',
                'Régionale' => 'regionale',
        ...
        ->add('microcalcifications_forme_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('microcalcifications_topographie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'du quadrant' => 'quadrant',
                'à l\'union' => 'union',
        ...
        ->add('microcalcifications_quadrant_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supéroexterne' => 'superoexterne',
                'supérointerne' => 'superointerne',
        ...
        ->add('microcalcifications_union_quadrants_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supérieurs' => 'superieurs',
                'internes' => 'internes',
        ...
        ->add('microcalcifications_profondeur_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'antérieur' => 'anterieur',
                'moyen' => 'moyen',
        ...
        ->add('microcalcifications_taille_x_droite', TextType::class, [
            'required' => false,
            'attr' => [
                'class' => 'form-control',
                'type' => 'number',
        ...
        ->add('microcalcifications_taille_y_droite', TextType::class, [
            'required' => false,
            'attr' => [
                'class' => 'form-control',
                'type' => 'number',
        ...
        ->add('microcalcifications_comparaison_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Apparues' => 'apparues',
        ...
        ->add('microcalcifications_anomalie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Aucune' => 'aucune',
                'Masse' => 'masse',
        ...
        ->add('microcalcifications_attitude_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Bénin' => 'benin',
                'Suivi' => 'suivi',
        ...
        ->add('calcifications_non_suspectes_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Non' => 'non',
                'Oui' => 'oui'
        ...
        ->add('calcifications_type_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('desorganisation_architecturale_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
        ...
        ->add('desorganisation_topographie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'du quadrant' => 'quadrant',
                'à l\'union' => 'union',
        ...
        ->add('desorganisation_quadrant_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supéroexterne' => 'superoexterne',
                'supérointerne' => 'superointerne',
        ...
        ->add('desorganisation_union_quadrants_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'supérieurs' => 'superieurs',
                'internes' => 'internes',
        ...
        ->add('prolongement_axillaire_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Oui' => 'oui',
                'Non' => 'non'
        ...
        ->add('prolongement_axillaire_type_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Libre' => 'libre',
        ...
        // Téguments cutanés
        ->add('teguments_cutanes_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Normal' => 'normal',
                'Épaissi' => 'epaissi',
        ...
        ->add('teguments_epaissi_type_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Diffus' => 'diffus',
                'Focal' => 'focal'
        ...
        ->add('teguments_epaissi_rt_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'RT+' => 'rt_plus',
                'RT-' => 'rt_minus'
        ...
        ->add('teguments_epaissi_topographie_droite', ChoiceType::class, [
            'choices' => [
                'Non renseigné' => '',
                'Supérieur' => 'superieur',
                'Interne' => 'interne',
        ...
        ->add('teguments_commentaire_droite', TextType::class, [
            'required' => false,
            'attr' => [
                'class' => 'form-control',
        ...
        // Creux axillaire
        ->add('creux_axillaire_droite', ChoiceType::class, [
        ...
        // Pour ADM simple
        ->add('creux_axillaire_adm_type_droite', ChoiceType::class, [
        ...
        ->add('creux_axillaire_cortex_taille_droite', TextType::class, [
        ...
        ->add('creux_axillaire_adm_petit_axe_taille_droite', TextType::class, [
        ...
        // Pour ADMs
        ->add('creux_axillaire_adms_nombre_droite', TextType::class, [
        ...
        ->add('creux_axillaire_adms_taille_droite', TextType::class, [
        ...
        ->add('creux_axillaire_commentaire_droite', TextType::class, [
            'label' => 'Commentaire',
            'required' => false,
            'attr' => [
                'class' => 'form-control',
